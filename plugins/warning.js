let handler = async (m, { conn, groupMetadata }) => {
    ...
    if (warn < 2) {
        ...
        m.reply(`⚠️ *WARNING +1*`)
        m.reply('Kamu mendapatkan kartu kuning dari admin, total warn kamu sekarang *' + (warn + 1) + '* warn, Jika kamu mendapat kartu kuning *3 kali*, kamu akan dikeluarkan dari grup', mention)
    } else if (warn == 2) {
