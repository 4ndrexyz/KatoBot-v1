...
const defaultMenu = {
  before: `
Hallo %name, saya disini siap membantu anda
...
function ucapan() {
  ...
  res = "Hallo "
  if (waktuu >= 4 && waktuu < 10) {
    res = "Selamat Pagi"
  }
  if (waktuu >= 10 && waktuu < 15) {
    res = "Selamat Siang"
  }
  if (waktuu >= 15 && waktuu < 18) {
    res = "Selamat Sore"
  }
  if (waktuu >= 18 || waktuu < 4) {
    res = "Selamat Malam"
  }
  return res
}
